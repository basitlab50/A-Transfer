        ...
        <AppCard className="mb-4">
          <View className="flex-row justify-between items-start mb-4">
            ...
            <View className="items-end">
              ...
              {mode === 'deposit' && (
                <View className="mt-2 bg-accent/5 px-2 py-1 rounded-md border border-accent/10">
                  <Text className="text-accent text-[8px] font-bold">LIMIT: {item.sellingMin || 5} - {item.merchantInventory || 0} A</Text>
                </View>
              )}
              {mode === 'withdraw' && (
